...
const Sort = () => {
  const{filtered_products,gridView,setGridView,setListView,sort,sorting}=useFilterContext()
...
<form>
  ...
  <select name="sort" id="sort" className="sort-input" value={sort} onChange={sorting}>
